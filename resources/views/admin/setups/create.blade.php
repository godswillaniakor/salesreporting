...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.setups.store']]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('cvd', trans('quickadmin.setup.fields.cvd').'*', ['class' => 'control-label']) !!}
                    {!! Form::text('cvd', old('cvd'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
